...
var userAvatar = _MASTERIYO_.userAvatar;
...
var AvatarMenu = function AvatarMenu() {
  return /*#__PURE__*/external_React_default().createElement(chakra_ui_menu_esm/* Menu */.v2, {
    ...
    color: "gray.500",
    href: //@ts-ignore
    "".concat(_MASTERIYO_.urls.account),
    isExternal: true
    ...
    color: "gray.500",
    href: //@ts-ignore
    "".concat(_MASTERIYO_.urls.logout),
    isExternal: true
  }, /*#__PURE__*/external_React_default().createElement(chakra_ui_menu_esm/* MenuItem */.sN, {
...
// @ts-ignore
var logoData = window._MASTERIYO_.logo; // @ts-ignore

var siteTitle = window._MASTERIYO_.siteTitle; // @ts-ignore

var courseUrl = window._MASTERIYO_.urls.courses; // @ts-ignore

var homeUrl = window._MASTERIYO_.urls.home;
...
var Header = function Header(props) {
  ...
  return /*#__PURE__*/external_React_default().createElement((external_React_default()).Fragment, null, /*#__PURE__*/external_React_default().createElement(chakra_ui_layout_esm/* Box */.xu, {
    ...
    href: homeUrl
  }, '' != logoData ? /*#__PURE__*/external_React_default().createElement(chakra_ui_image_esm/* Image */.Ee, {
    src: logoData[0],
    height: "36px"
  }) : /*#__PURE__*/external_React_default().createElement(chakra_ui_layout_esm/* Text */.xv, {
    textAlign: "center"
  }, siteTitle))), /*#__PURE__*/external_React_default().createElement(chakra_ui_layout_esm/* Stack */.Kq, {
    direction: "row",
    spacing: "6",
    align: "center",
    flex: "1",
    ...
    align: "center",
    color: "gray.400"
  }, /*#__PURE__*/external_React_default().createElement(components_AvatarMenu, null))))))), summary.total.completed === summary.total.pending + summary.total.completed && /*#__PURE__*/external_React_default().createElement(chakra_ui_layout_esm/* Container */.W2, {
    centerContent: true,
    maxW: "container.xl"
    ...
    mr: 2
  }, (0,external_wp_i18n_namespaceObject.__)('Congratulations!', 'masteriyo')), /*#__PURE__*/external_React_default().createElement(chakra_ui_alert_esm/* AlertDescription */.X, null, (0,external_wp_i18n_namespaceObject.__)('You have successfully completed this course.', 'masteriyo'))), /*#__PURE__*/external_React_default().createElement(chakra_ui_layout_esm/* Link */.rU, {
    href: courseUrl
  }, /*#__PURE__*/external_React_default().createElement(chakra_ui_button_esm/* Button */.zx, {
    size: "sm"
...
var QaChat = function QaChat(props) {
  ...
  if (chatQuery.isSuccess) {
    return /*#__PURE__*/external_React_default().createElement(chakra_ui_layout_esm/* Stack */.Kq, {
      ...
      px: "4",
      overflowY: "auto"
    }, chatQuery.data.map(function (chat) {
...
var myAccountUrl = window._MASTERIYO_.urls.account;
/*
...
var QuestionList = function QuestionList() {
  ...
  if (qaQuery.isSuccess) {
    ...
    return /*#__PURE__*/external_React_default().createElement(chakra_ui_layout_esm/* Stack */.Kq, {
      ...
      flex: "1",
      overflowY: "auto"
    }, qaQuery.data.map(function (question, index) {
      return /*#__PURE__*/external_React_default().createElement(chakra_ui_layout_esm/* Link */.rU, {
        ...
        onClick: function onClick() {
          return onQuestionPress(question.id, question.content, question.answers_count);
        }
      }, /*#__PURE__*/external_React_default().createElement(chakra_ui_layout_esm/* Stack */.Kq, {
        direction: "column",
        spacing: "2"
        ...
        fontSize: "x-small",
        color: "gray.500"
      }, (0,external_wp_i18n_namespaceObject.sprintf)((0,external_wp_i18n_namespaceObject._nx)('%d Answer', '%d Answers', question.answers_count, 'number of answers', 'masteriyo'), question.answers_count))), /*#__PURE__*/external_React_default().createElement(chakra_ui_icon_esm/* Icon */.JO, {
        transition: "all 0.35s ease-in-out",
        as: index_esm/* BiChevronRight */.lU2,
        fontSize: "x-large",
        color: "gray.600"
...
//@ts-ignore
var qaEnable = _MASTERIYO_.qaEnable;
...
var Sidebar = function Sidebar(props) {
  ...
  }, (0,external_wp_i18n_namespaceObject.__)('Lessons', 'masteriyo')), qaEnable && /*#__PURE__*/external_React_default().createElement(chakra_ui_button_esm/* Button */.zx, {
...
var get_video_id_esm = __webpack_require__(4329);
...
var VideoPlayer = function VideoPlayer(props) {
  ...
  var _getVideoId = (0,get_video_id_esm/* default */.Z)(url || ''),
      id = _getVideoId.id;

  return /*#__PURE__*/external_React_default().createElement((external_React_default()).Fragment, null, type === 'youtube' && /*#__PURE__*/external_React_default().createElement("iframe", {
    id: "ytplayer",
    width: "100%",
    height: "500",
    src: 'https://www.youtube.com/embed/' + id,
    allowFullScreen: true
  }), type === 'vimeo' && /*#__PURE__*/external_React_default().createElement("iframe", {
    src: 'https://player.vimeo.com/video/' + id,
    width: "100%",
    height: "500",
    allow: "autoplay; fullscreen; picture-in-picture"
  }), type === 'self-hosted' && /*#__PURE__*/external_React_default().createElement(chakra_ui_layout_esm/* Box */.xu, {
    sx: {
      position: 'relative',
      overflow: 'hidden',
      width: '100%',
...
var QuizFields = function QuizFields(props) {
  ...
  if (questionQuery.isSuccess) {
    return /*#__PURE__*/external_React_default().createElement((external_React_default()).Fragment, null, /*#__PURE__*/external_React_default().createElement(chakra_ui_layout_esm/* Stack */.Kq, {
      ...
      fontSize: "sm",
      p: "2.5"
    }, /*#__PURE__*/external_React_default().createElement(chakra_ui_alert_esm/* AlertIcon */.zM, null), (0,external_wp_i18n_namespaceObject.__)('Your quiz time is about to expire!', 'masteriyo')), questionQuery.data.map(function (question) {
      return /*#__PURE__*/external_React_default().createElement(chakra_ui_layout_esm/* Stack */.Kq, {
        direction: "column",
        spacing: "8",
        key: question.id
...
var ScoreBoard = function ScoreBoard(props) {
  ...
  return /*#__PURE__*/external_React_default().createElement(chakra_ui_layout_esm/* Stack */.Kq, {
    ...
    fontWeight: "bold",
    flex: "0 0 150px"
  }, (0,external_wp_i18n_namespaceObject.__)('Earned Points:', 'masteriyo')), /*#__PURE__*/external_React_default().createElement(chakra_ui_layout_esm/* Text */.xv, null, scoreData.earned_marks))), /*#__PURE__*/external_React_default().createElement(chakra_ui_button_esm/* ButtonGroup */.hE, null, /*#__PURE__*/external_React_default().createElement(chakra_ui_button_esm/* Button */.zx, {
    colorScheme: "green",
    rounded: "full",
    fontWeight: "bold",
    leftIcon: /*#__PURE__*/external_React_default().createElement(chakra_ui_icon_esm/* Icon */.JO, {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [697], () => (__webpack_require__(6723)))
